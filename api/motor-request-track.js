...
export default async function handler(request, response) {
  ...
  const upstreamTargets = [
    ...
    {
      type: "health",
      url: `${baseUrl}/api/v1/public/health-requests/track/${encodedTrackingNumber}`,
    },
    {
      type: "health",
    ...
    },
    {
      ...
      url: `${baseUrl}/api/v1/public/general-accident-requests/track/${encodedTrackingNumber}`,
    },
    {
      type: "generalAccident",
    ...
    {
      type: "transport",
      url: `${baseUrl}/api/v1/public/transport-requests/track/${encodedTrackingNumber}`,
    },
    {
      type: "transport",
      url: `${baseUrl}/api/v1/public/transport-requests/${encodedTrackingNumber}`,
    },
  ];
